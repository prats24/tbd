...
router.route('/').get(kitchenController_1.getKitchens).post((0, authController_1.protect)(User_1.default), kitchenController_1.createKitchen);
...
router.route('/:id').get((0, authController_1.protect)(User_1.default), kitchenController_1.getKitchen).patch((0, authController_1.protect)(User_1.default), kitchenController_1.editKitchen).delete((0, authController_1.protect)(User_1.default), kitchenController_1.deleteKitchen);

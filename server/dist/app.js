...
const homeChefRoutes_1 = __importDefault(require("./routes/homeChefRoutes"));
...
app.use('/api/v1/kitchens', kitchenRoutes_1.default);
app.use('/api/v1/carousels', carouselRoutes_1.default);
